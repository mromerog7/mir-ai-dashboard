                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input type="date" {...field} disabled={readonly} className={`bg-[#E5E5E5] border-slate-200 text-black block w-full ${readonly ? "opacity-100 font-medium" : ""}`} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    >
                                        <FormControl>
                                            <SelectTrigger className={`w-full bg-[#E5E5E5] border-slate-200 text-black ${readonly ? "opacity-100 cursor-default font-medium" : ""}`}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Ej. Presentación de Avances" {...field} disabled={readonly} className={`bg-[#E5E5E5] border-slate-200 text-black placeholder:text-slate-400 ${readonly ? "opacity-100 text-lg font-bold" : ""}`} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
