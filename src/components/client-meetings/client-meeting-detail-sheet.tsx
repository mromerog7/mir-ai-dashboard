                ...
                <div key={index} className="flex gap-2 group items-start">
                    ...
                    <div className="flex-1 relative">
                        <Textarea
                            ...
                            disabled={readonly}
                            className={`bg-[#D6E8EE] border-slate-200 text-black min-h-[80px] resize-y placeholder:text-slate-400 ${readonly ? "opacity-100 bg-transparent border-none px-0 resize-none min-h-0 font-medium" : ""}`}
                        />
                    </div>
                    {!readonly && (
                        <Button
...
interface ClientMeetingDetailSheetProps {
...
export function ClientMeetingDetailSheet({ meeting, trigger, defaultProjectId, readonly = false }: ClientMeetingDetailSheetProps) {
    ...
    const form = useForm<FormValues>({
        ...
        defaultValues: {
            proyecto_id: meeting?.proyecto_id || defaultProjectId || undefined,
            fecha: meeting?.fecha ? meeting.fecha.split('T')[0] : format(new Date(), "yyyy-MM-dd"),
            titulo: meeting?.titulo || "",
            participantes: meeting?.participantes || "",
            puntos_tratados: meeting?.puntos_tratados || "",
            acuerdos: meeting?.acuerdos || "",
            pendientes: meeting?.pendientes || "",
            siguiente_reunion: meeting?.siguiente_reunion || "",
        },
    })
    ...
    }, [open, meeting, defaultProjectId, form])
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input type="date" {...field} disabled={readonly} className={`bg-[#D6E8EE] border-slate-200 text-black block w-full ${readonly ? "opacity-100 bg-transparent border-none px-0 font-medium" : ""}`} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    >
                                        <FormControl>
                                            <SelectTrigger className={`w-full bg-[#D6E8EE] border-slate-200 text-black ${readonly ? "opacity-100 bg-transparent border-none px-0 cursor-default font-medium" : ""}`}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Ej. Presentación de Avances" {...field} disabled={readonly} className={`bg-[#D6E8EE] border-slate-200 text-black placeholder:text-slate-400 ${readonly ? "opacity-100 bg-transparent border-none px-0 text-lg font-bold" : ""}`} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
