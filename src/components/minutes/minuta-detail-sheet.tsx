                ...
                <div key={index} className="flex gap-2 group items-start">
                    ...
                    <div className="flex-1 relative">
                        <Textarea
                            ...
                            disabled={readonly}
                            className={`bg-[#D6E8EE] border-slate-200 text-black min-h-[80px] resize-y ${readonly ? "opacity-100 bg-transparent border-none px-0 resize-none min-h-0 font-medium" : ""}`}
                        />
                    </div>
                    {!readonly && (
                        <Button
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Ej. Revisión Semanal de Avances" {...field} disabled={readonly} className={`bg-[#D6E8EE] border-slate-200 text-black ${readonly ? "opacity-100 bg-transparent border-none px-0 text-lg font-bold" : ""}`} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
