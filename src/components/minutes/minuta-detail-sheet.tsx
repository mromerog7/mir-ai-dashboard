                ...
                <div key={index} className="flex gap-2 group items-start">
                    ...
                    <div className="flex-1 relative">
                        <Textarea
                            ...
                            disabled={readonly}
                            className={`bg-[#E5E5E5] border-slate-200 text-black min-h-[80px] resize-y ${readonly ? "opacity-100 resize-none font-medium" : ""}`}
                        />
                    </div>
                    {!readonly && (
                        <Button
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Ej. Revisión Semanal de Avances" {...field} disabled={readonly} className={`bg-[#E5E5E5] border-slate-200 text-black ${readonly ? "opacity-100 text-lg font-bold" : ""}`} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
