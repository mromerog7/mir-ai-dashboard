...
// For now, I'll assume we might need to use the existing dialog or create a new wrapper.
// Actually, I should check if ReportDetailSheet exists. 
// Based on previous task list: "Create Detail Dialog/Sheet" was done. 
// Let's assume it's `ReportDetailSheet` or similar. I'll check file list if I get an error, 
// but for now I'll use a placeholder or best guess based on patterns.
// Wait, looking at task.md: "- [x] Create Detail Dialog/Sheet" under Reportes Module.
// I'll check the file structure first to be sure.
